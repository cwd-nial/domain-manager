        ...
        <div className="max-w-sm space-y-4">
            ...
            {approved ? (
                <p className="text-sm text-green-700 dark:text-green-400">
                    Your request was approved. Please sign out and sign back in to activate admin
                    access.
                </p>
            ) : pending ? (
                <p className="text-sm text-gray-600 dark:text-gray-400">
                ...
                <>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                        Submit a request to gain admin access. An existing admin will need to approve
                        it.
                    </p>
                    <RequestAdminButton />
                </>
